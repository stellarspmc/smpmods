...
object TreasureHelper {
    ...
    enum class Biomes(private val biomes: MutableList<String>) { // TODO: eval, not complete?
        ...
        companion object {
            ...
            val OVERWORLD = listOf(BADLANDS, DESERT, DRIP, DARK_FOREST, SCULK, LUSH, MUSHROOM, SWAMP, JUNGLE, TAIGA, SAVANNA, OCEAN, FLOWER, ICE, MOUNTAIN, WINDSWEPT)
            val NETHER_LIST = listOf(BASALT, CRIMSON, WARPED, SOUL, NETHER) // TODO: check if all nether biomes are included (amplified nether)
